...
#define WISP_DB_LP_SRAM_SIZE_BYTES   (ESP32_C6_LP_SRAM_SIZE_KB * 1024)    // 16KB LP-SRAM pool
#define WISP_DB_HP_SRAM_MAX_BYTES    (256 * 1024)                        // Up to 256KB HP-SRAM pool
#define WISP_DB_DEFAULT_SIZE_BYTES   WISP_DB_LP_SRAM_SIZE_BYTES           // Default to LP-SRAM for persistence
...
// ESP32-C6 supports Bluetooth 5.0 LE (Low Energy) only, not Classic Bluetooth
#define BLUETOOTH_TYPE_BLE          1              // Bluetooth Low Energy support
#define BLUETOOTH_TYPE_BTE          0              // Bluetooth Classic (Traditional) not supported
...
#define WISP_HAS_BLUETOOTH_CLASSIC  0              // Bluetooth Classic NOT available (ESP32-C6 is BLE-only)
...
// LED availability flag (for LED controller)
#define WISP_HAS_RGB_LED            1              // RGB LED available on this board

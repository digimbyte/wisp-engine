// src/utils/panels/display_settings.h
#pragma once
...
private:
    ...
    void applySettings() {
        ...
        api->print("Applied brightness: " + String(brightness));
        
        // Apply color profile
        api->print("Applied color profile: " + String(colorProfile));
    ...
    void saveSettings() {
        ...
        api->saveData("display.brightness", String(brightness));
        api->saveData("display.colorProfile", String(colorProfile));
        api->saveData("display.vsync", String(vsyncEnabled));
        api->saveData("display.screenSaver", String(screenSaver));
